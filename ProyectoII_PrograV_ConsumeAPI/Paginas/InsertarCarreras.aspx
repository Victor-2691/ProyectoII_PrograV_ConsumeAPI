    ...
    <form id="form1" runat="server">
        <div>
            ...
            <br />
             ...
             <input type="text" id="txtCodigo_Carrera"  placeholder="Codigo de Carrera" runat="server" required="required" maxlength="10"/>  
             <br />
           ...
           <input type="text" id="txtNombre_Carrera"  placeholder="Nombre de la Carrera" runat="server" required="required" maxlength="30"/>
            ...
            <br />
            <asp:Button ID="Btn_Regresar" runat="server" Text="" OnClick="Btn_Regresar_Click" />
