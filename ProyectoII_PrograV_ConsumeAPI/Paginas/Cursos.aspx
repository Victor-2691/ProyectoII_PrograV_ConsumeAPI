<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cursos.aspx.cs" Inherits="ProyectoII_PrograV_ConsumeAPI.Paginas.Cursos" %>
...
<body>
    <form id="form1" runat="server">
        <div>
      <h1>Cursos</h1>
    <asp:GridView ID="GriedvCursos" runat="server" OnSelectedIndexChanged="GriedvCursos_SelectedIndexChanged">
             <Columns>
